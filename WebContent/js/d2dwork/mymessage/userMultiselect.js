...
userMultiselect.init = function(callback, userids, creatorUserName) {

    var userstroe = new Ext.data.Store({
                proxy : new Ext.data.HttpProxy({
                            url : '../../JSON/userinfo_UserInfoRemote.getUserByGroupFilterUserids'
                        }),
    ...
    userstroe.baseParams.filterUseridsStr = userids;
