...
var renwukbnMain = {renwukbnpanel:null,renwukbngrid1:null,renwukbngrid2:null,sign:null,selectages:null,
				args:{start:0,limit:25},count:0,counts:0,baseargsfz:null,baseargszf:null,dbsxztai:null,showbt:null,isload:true,paramvalue:null};
...
renwukbnMain.getdialog = function(response){
  	...
  	renwukbnMain.combo1.on('select',function(combo,record,num){
						...
						if(num==4){
							...
							proxy = new Ext.data.HttpProxy({
       				 		...
       				 		//隐藏开启.net按钮
							document.getElementById("chengxut").style.display='none';
						} else {
							proxy = new Ext.data.HttpProxy({
							...
							//开启.net按钮
							document.getElementById("chengxut").style.display='';
						}
...
//							cm.setHidden(12,true);
	...
	renwukbnGrid.setcm2();
	renwukbnMain.renwukbngrid1 = renwukbnGrid.grid(2);
	var cm = renwukbnMain.renwukbngrid1.getColumnModel();
	cm.setHidden(3,true);
	...
	renwukbnMain.renwukbngrid2 = renwukbnGrid.grid(2);
...
//						'<a style="cursor: hand" onclick="renwukbnQuery.temp(renwukbnMain.renwukbngrid1)">' +
//						'<IMG id = "chengxut" SRC="../images/startnetexe.jpg" align="middle"></a>' + 
					'</div>' +
	...
	renwukbnMain.gridpanel  = new Ext.Panel({
						...
						id:'tabpanel3',
						layout:'border',
					 	title:''+getResource('resourceParam1650')+'',
					 	autoScroll:false,
					 	items:[		 	 
					 	renwukbnMain.renwukbngrid1,
					 	renwukbnMain.showForm1]
					 });
	renwukbnMain.gridpanelsend = new Ext.Panel({
						...
						id:'tabpanel4',
						layout:'border',
					 	title:''+getResource('resourceParam1651')+'',
