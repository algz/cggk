...
Controller= function()
{
    ...
    var store = new Ext.ux.maximgb.tg.NestedSetStore({
    	autoLoad : true,
    	url: '../JSON/webremote_DataObjectRemote.getTaskdataObject?id='+taskid,
    ...
    var grid = new Ext.ux.maximgb.tg.GridPanel({
      ...
      cm: new Ext.grid.ColumnModel({
		...
		columns : [
				{id:'id'},
        {header: ""+getResource('resourceParam480')+"", width: 75, renderer: 'name', dataIndex: 'name'},
        {header: ""+getResource('resourceParam481')+"", width: 75, renderer: 'type', dataIndex: 'type'},
        {header: ""+getResource('resourceParam854')+"", width: 75, renderer: 'inout', dataIndex: 'inout'},
        {header: ""+getResource('resourceParam511')+"", width: 85, renderer: 'value', dataIndex: 'value'}
      ]}),
      stripeRows: true,
      autoExpandColumn: 'id',
