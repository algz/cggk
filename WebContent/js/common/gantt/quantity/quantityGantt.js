Ext.ns('Sch.QuantityGanttApp');

Sch.QuantityGanttApp.init = function(today) {
    Ext.QuickTips.init();
    ...
    return Sch.QuantityGanttApp.Gantt.init(today);
}

Sch.QuantityGanttApp.Gantt = {
...
//            defaultExpanded : true,
            ...
            proxy : new Ext.data.HttpProxy({
                url : "../JSON/gantt_ganttRemote.getGanttList?nodeid=0",
                method : "POST"
            }),
            baseParams : {
                start : '0',
