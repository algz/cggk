...
Ext.extend(Ext.tree.TreeCheckNodeUI, Ext.tree.TreeNodeUI, {   
     ...
     renderElements : function(n, a, targetNode, bulkRender){   
        ...
        this.checkBoxHidden = tree.checkBoxHidden || false;   
     ...
     var ch = this.checkBoxHidden ? 'x-tree-node-cb-hidden':'x-tree-node-cb';
        var href = a.href ? a.href : Ext.isGecko ? "" : "javascript:void(0);";   
        
        var buf = ['<li class="x-tree-node"><div ext:tree-node-id="',n.id,'" class="x-tree-node-el x-tree-node-leaf x-unselectable ', a.cls,'" unselectable="on">',   
            '<span class="x-tree-node-indent">',this.indentMarkup,"</span>",   
            '<img src="', this.emptyIcon, '" class="x-tree-ec-icon x-tree-elbow" />',   
            '<img src="', a.icon || this.emptyIcon, '" class="x-tree-node-icon',(a.icon ? " x-tree-node-inline-icon" : ""),(a.iconCls ? " "+a.iconCls : ""),'" unselectable="on" />',   
             cb ? ('<input class="' + ch + '" type="checkbox" ' + (a.checked ? 'checked="checked" />' : '/>')) : '',   
