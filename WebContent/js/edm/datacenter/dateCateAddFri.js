...
dateCateAddFri.init = function() {
	...
	var categoryInstanceName = new Ext.form.TextField({
				fieldLabel : '&nbsp &nbsp &nbsp'+getResource('resourceParam480')+'',
...
//				},
	...
	var categoryType = new Ext.form.ComboBox({
				fieldLabel : '&nbsp &nbsp &nbsp'+getResource('resourceParam481')+'',
				name : 'categoryType',
	...
	var description = new Ext.form.TextArea({
				name : 'description',
				fieldLabel : '&nbsp &nbsp &nbsp'+getResource('resourceParam648')+'',
				style : 'margin-bottom:5px',
				validator : function() {
	...
	var addform = new Ext.FormPanel({
		...
		buttons : [{
			...
			listeners : {
				'click' : function() {
					Ext.getCmp("datacenter_add").close();
//					addform.getForm().reset();
				}
			}
		}]
