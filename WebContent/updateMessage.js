...
updateMessage.init = function(messageid, messageType) {
...
function getMessageCallBack(result) {
	...
	function logSubmit() {
		...
		logAddForm.getForm().submit({
			url : 'logupdate?logName=' + '' + '&logContent=' + ''
					+ '&messageid=' + Ext.getCmp('logid').getValue()
					+ '&updateReason=' + '' + '&publishMode=4',
			method : 'post',
			// params:logAddForm,
	...
	function logSave() {
		...
		logAddForm.getForm().submit({
			url : 'logupdate?logName=' + '' + '&logContent='
					+ Ext.getCmp('logContent').getValue() + '&messageid='
					+ Ext.getCmp('logid').getValue() + '&updateReason=' + ''
					+ '&publishMode=1',
			method : 'post',
			// params:logAddForm,
			success : function(form, action) {
