...
<div id="goback" class="goback"><a href="feedbackreply.seam?status=<h:outputText value="#{messageReceiveVo.allstatus}" />"><%=session.getAttribute("resourceParam_450")%></a></div>
...
<!--			        <a href="log_comment.html"><%=session.getAttribute("resourceParam_1860")%>&gt;&gt;</a>-->
<!--                </div>-->
	         ...
	         <form id="feedbackform<h:outputText value="#{leafnews.level}" />" name="feedbackform<h:outputText value="#{leafnews.level}" />" action="../../MessageReceiveServlet" method="post" enctype="multipart/form-data"> 
                    <div id="log_reply_content<h:outputText value="#{leafnews.level}"/>" class="log_reply_content">
                       ...
                       <textarea id="content<h:outputText value="#{leafnews.level}"/>" name="content<h:outputText value="#{leafnews.level}"/>" 
                       		style="width: 400px; height: 100px;" onkeyup="warnFeedBackReplyThree(this.value, <h:outputText value="#{leafnews.level}"/>)"></textarea>
                   		<div id="warnFeedBackReplyThree<h:outputText value="#{leafnews.level}"/>"></div>
                    </div>
...
<!--            <div class="log_content"></div>-->
			<div id="log_reply_all_content<h:outputText value="#{news.level}" />">
			   ...
			   <textarea id="allcontent<h:outputText value="#{news.level}" />" name="allcontent<h:outputText value="#{news.level}" />" 
			   		style="width: 400px; height: 100px;margin:20px 0px 0px 0px;" onkeyup="warnFeedBackReplyTwo(this.value)"></textarea>
            </div>
            <dir id="warnFeedBackReplyTwo" style="margin:0px 0px 0px -2px"></dir>
