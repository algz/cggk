...
<div id="goback" class="goback"><a href="worklogreply.seam?status=<h:outputText value="#{messageReceiveVo.allstatus}" />"><%=session.getAttribute("resourceParam_450")%></a></div>
		...
		<rich:column>
			<div id="log_box<h:outputText value="#{news.level}" />" class="log_box">
                <div id="log_title<h:outputText value="#{news.level}" />" class="log_title">
                   <a href="javascript:void(0);"><h:outputText value="#{news.truename}" /></a> 提出一<%=session.getAttribute("resourceParam_539")%>对<%=session.getAttribute("resourceParam_1864")%>[<font color="red"><h:outputText value="#{news.taskname}" /></font>]的<%=session.getAttribute("resourceParam_1937")%>
	         ...
	         <form id="feedbackform<h:outputText value="#{leafnews.level}" />" name="feedbackform<h:outputText value="#{leafnews.level}" />" action="../../MessageReceiveServlet" method="post" enctype="multipart/form-data"> 
                    <div id="log_reply_content<h:outputText value="#{leafnews.level}"/>" class="log_reply_content">
                       ...
                       <textarea id="content<h:outputText value="#{leafnews.level}"/>" name="content<h:outputText value="#{leafnews.level}"/>" 
                       		style="width: 400px; height: 100px;" onkeyup="warnWorkReplyTwo(this.value, <h:outputText value="#{leafnews.level}"/>)"></textarea>
                    	<div id="warnWorkReplyTwo<h:outputText value="#{leafnews.level}"/>"></div>
                    </div>
...
<!--            <div class="log_content"></div>-->
			<div id="log_reply_all_content<h:outputText value="#{news.level}" />">
			   ...
			   <textarea id="allcontent<h:outputText value="#{news.level}" />" name="allcontent<h:outputText value="#{news.level}" />" 
			   		style="width: 400px; height: 100px; margin:20px 0px 0px 0px;" onkeyup="warnWorkOne(this.value)"></textarea>
            </div>
            <div id="warnWorkOne"></div>
