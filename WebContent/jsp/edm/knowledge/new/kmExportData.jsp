...
<div id="main">
    <input type="button" value="导出词条" id="serializeDict"/>
    <input type="button" value="导出文档" id="serializeFile"/>
    <input type="button" value="导出分类树" id="serializeTree"/>
    <br/>
    <div style="color:red">
        序列化词条和序列化文档的功能是把以前录入的词条及文档数据从数据库中提取出来,<br/>
        然后转成二进制文件
    </div>
    <div style="color:blue">
        序列化分类树的功能是把以前创建的分类树转成目前系统的分类树结构，并转成二进制文件。
    </div>
    <br/>
