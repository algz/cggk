...
warehouseObjectList.grid = function() {
	var strurl = '../JSON/qualityMgm_qualityTemplate.getWarehouseObjectList';
	...
	var reader = new Ext.data.JsonReader({
				...
				id : 'categoryId'
			}, ['categoryId', 'categoryName', 'type', 'groups', 'description','version', 'dataType']);
					...
					rowselect : function(sm, rowIndex, record) {
						if (sm.getCount() == 1) {
							...
							var attributePanel = wareHouseAttribute.init(
									...
									record.get("categoryId"), record.get("description"));
