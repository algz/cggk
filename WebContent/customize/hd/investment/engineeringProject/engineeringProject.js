...
Ext.Ajax.request({
	...
	success : function(response, opts) {
		...
		main.CHECK = !check_roles(obj.data,"4664056")//验收任务
			...
			new Ext.Viewport({
				layout:'fit',
						items : [{
									...
									activeItem:0,
									items : [
										new implementationPlan2.mainGrid(),//实施计划
										new executiveManagement2.mainGrid(),//执行管理
										new contractManagement.mainGrid(),//合同管理
										new inspectionApplication.mainGrid(),//验收申请
										//new paymentTaskManager.mainGrid(),
										//acceptTask.init(0,20,2),
										paymentTask.init(0,20,2)
									]
								}]
