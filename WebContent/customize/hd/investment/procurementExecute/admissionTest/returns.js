...
**/
var returns = {};
returns.getForm = function(checkType,checkDetailId,objectNo,objectName,objectComment,
						...
						'submit',
						{
							...
							success : function(form, action) {//在这处理逻辑。
								...
								//修改“处理状态”
								 ...
								 remote.UpdateArrivalCheck(grid.getSelectionModel().getSelections()[0].data.registrationId,'6', function(result){ 
