//招标管理登记
var tenderRegisterForm= {
		
};


tenderRegisterForm.getForm = function(tenderId,procurementPlanDetilName,tenderFileType,tenderFileCode,plenipotentiary,
						...
						Ext.Ajax
								.request( {
									...
									params : {
										...
										procurementPlanDetilName : tenderFileForm.form.findField('procurementPlanDetilName').getRawValue(),
...
//	},
	{
		...
		id : 'send',
		handler : function() {
			tenderFileAction.submitTenderFile('442751','招标管理登记表',tenderFileId+tenderFileType);
		}
	},
//	{
//		text : '打印',
