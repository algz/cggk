//委托文件
var tenderEntrusForm= {
		
};
//委托文件
tenderEntrusForm.getEntrustFileForm = function(tenderId,procurementPlanDetilName,tenderFileType,tenderFileCode,
						...
						Ext.Ajax
								.request( {
									...
									params : {
										...
										agreementdepartment:tenderFileForm.form.findField('agreementDepartment').getRawValue(),
