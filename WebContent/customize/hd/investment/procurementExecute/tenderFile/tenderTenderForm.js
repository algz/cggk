//招标文件
var tenderTenderForm= {
		
};


tenderTenderForm.getForm = function(tenderId,procurementPlanDetilName,tenderFileType,tenderFileCode,plenipotentiary,
			...
			if (tenderFileForm.form.isValid()) {
				tenderFileForm.form.doAction('submit', {
					...
					failure : function(form, action) {
						Ext.Msg.alert('提示',action.result,tenderFileId);
					}
...
//	}, 
	{
		...
		id : 'send',
		handler : function() {
			tenderFileAction.submitTenderFile("442750","招标文件会审",tenderFileId+tenderFileType);
		}
	}, 
//	{
//		text : '打印',
