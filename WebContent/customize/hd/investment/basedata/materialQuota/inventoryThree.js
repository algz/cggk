...
inventoryThree.gridPanel = function() {
...
inventoryThree.tabPanel = function() {
	var tab = new Ext.Panel( {
		title : '工具清册',
		id : 'inventoryThreeTab',
		layout : 'fit',
		items : [ inventoryThree.gridPanel() ],
		listeners : {
			'activate' : function() {
				materialQuotaMain.useType = 4;
				var grid = Ext.getCmp('inventoryThreePanelId');
