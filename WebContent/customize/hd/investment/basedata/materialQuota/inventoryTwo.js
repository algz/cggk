...
inventoryTwo.gridPanel = function() {
...
inventoryTwo.tabPanel = function() {
	var tab = new Ext.Panel( {
		title : '设备清册',
		id : 'inventoryTwoTab',
		layout : 'fit',
		items : [ inventoryTwo.gridPanel() ],
		listeners : {
			'activate' : function() {
				materialQuotaMain.useType = 3;
				var grid = Ext.getCmp('inventoryTwoPanelId');
