var mxClient = {
    ...
    isBrowserSupported: function() {
        return this.IS_IE || this.IS_MT || this.IS_IE6 || this.IS_SVG;
    },
...
if (typeof(mxLanguage) != 'undefined') {
    ...
    mxClient.language = (mxClient.IS_IE || mxClient.IS_IE6) ? navigator.userLanguage: navigator.language;
...
if (mxClient.IS_IE || mxClient.IS_IE6) {
...
var mxLog = {
    ...
    init: function() {
        if (mxLog.window == null && document.body != null) {
            ...
            if (!mxClient.IS_IE && !mxClient.IS_IE6 && document.compatMode != 'BackCompat') {
...
var mxUtils = {
    ...
    setOpacity: function(node, value) {
        ...
        } else if (mxClient.IS_IE || mxClient.IS_IE6) {
            if (value >= 100) {
                node.style.filter = null;
            } else {
...
var mxConstants = {
    ...
    OUTLINE_STROKEWIDTH: (mxClient.IS_IE || mxClient.IS_IE6) ? 2 : 3,
    HANDLE_SIZE: 7,
    LABEL_HANDLE_SIZE: 4,
...
var mxEvent = {
    ...
    isLeftMouseButton: function(evt) {
        return evt.button == ((mxClient.IS_IE || mxClient.IS_IE6) ? 1 : 0);
    },
...
mxWindow.prototype.init = function(x, y, width, height, style) {
    ...
    if (!(mxClient.IS_IE || mxClient.IS_IE6) && mxClient.WINDOW_SHADOWS) {
    ...
    } else if ((mxClient.IS_IE || mxClient.IS_IE6) && !mxClient.WINDOW_SHADOWS) {
    ...
    if (mxClient.IS_IE || mxClient.IS_IE6 || this.content.nodeName.toUpperCase() != 'DIV') {
...
mxWindow.prototype.show = function() {
    ...
    this.activate();
    var style = mxUtils.getCurrentStyle(this.contentWrapper);
    if (!(mxClient.IS_IE || mxClient.IS_IE6) && (style.overflow == 'auto' || this.resize != null)) {
        this.contentWrapper.style.height = (this.div.offsetHeight - this.title.offsetHeight - 2) + 'px';
    }
...
mxPopupMenu.prototype.init = function() {
    ...
    this.div.appendChild(this.table);
    if (!(mxClient.IS_IE || mxClient.IS_IE6) && mxClient.MENU_SHADOWS) {
        this.shadow = document.createElement('div');
        this.shadow.className = 'mxPopupMenuShadow';
        this.shadow.style.zIndex = this.zIndex - 1;
        mxUtils.setOpacity(this.shadow, 70);
    } else if ((mxClient.IS_IE || mxClient.IS_IE6) && !mxClient.MENU_SHADOWS) {
        this.div.style.filter = '';
    }
...
mxPopupMenu.prototype.showSubmenu = function(parent, row) {
    if (row.div != null) {
        ...
        var right = (b.scrollLeft || d.scrollLeft) + (b.clientWidth || d.clientWidth);
        if (left + width > right) {
            row.div.style.left = (parent.div.offsetLeft - width + ((mxClient.IS_IE || mxClient.IS_IE6) ? 6 : -6)) + 'px';
        }
        mxUtils.fit(row.div);
    }
};
...
mxText.prototype.create = function(container) {
    ...
    if (this.dialect == mxConstants.DIALECT_SVG) {
        ...
        if ((!(mxClient.IS_IE || mxClient.IS_IE6)) && !mxClient.NO_FO) {
...
mxText.prototype.redrawHtmlTable = function() {
    ...
    } else if (this.IS_MT || this.IS_SVG) {
    ...
    if (this.overflow != 'fill') {
        ...
        if (!(mxClient.IS_IE || mxClient.IS_IE6) || oldBrowser) {
            if (!(mxClient.IS_IE || mxClient.IS_IE6)) {
...
mxGraphView.prototype.installListeners = function() {
    ...
    if (container != null) {
        ...
        function(evt) {
            if (this.isContainerEvent(evt) && ((!(mxClient.IS_IE || mxClient.IS_IE6) && !false && !false && !false) || !this.isScrollEvent(evt))) {
...
mxGraph.prototype.sizeDidChange = function() {
    ...
    if (this.container != null) {
        ...
        if (this.preferPageSize || (!(mxClient.IS_IE || mxClient.IS_IE6) && this.pageVisible)) {
...
mxGraphHandler.prototype.maxCells = (mxClient.IS_IE || mxClient.IS_IE6) ? 20 : 50;
        ...
        if (this.focusIcons != null && this.constraints != null && (me.getState() == null || this.currentFocus == me.getState())) {
            for (var i = 0; i < this.focusIcons.length; i++) {
                if (mxUtils.intersects(this.focusIcons[i].bounds, mouse)) {
                    ...
                    tmp.grow((mxClient.IS_IE || mxClient.IS_IE6) ? 3 : 2);
                    if (mxClient.IS_IE || mxClient.IS_IE6) {
                        tmp.width -= 1;
                        tmp.height -= 1;
                    }
...
mxEdgeHandler.prototype.mouseDown = function(sender, me) {
    var handle = null;
    if (!(mxClient.IS_IE || mxClient.IS_IE6) || me.getState() == this.state) {
...
mxTooltipHandler.prototype.init = function() {
    if (document.body != null) {
        ...
        this.div.style.visibility = 'hidden';
        this.div.style.zIndex = this.zIndex;
        if (!(mxClient.IS_IE || mxClient.IS_IE6) && mxClient.TOOLTIP_SHADOWS) {
            this.shadow = document.createElement('div');
            ...
            mxUtils.setOpacity(this.shadow, 70);
            document.body.appendChild(this.shadow);
        } else if ((mxClient.IS_IE || mxClient.IS_IE6) && !mxClient.TOOLTIP_SHADOWS) {
            this.div.style.filter = '';
        }
        document.body.appendChild(this.div);
...
mxCodec.prototype.encode = function(obj) {
    ...
    if (obj != null && obj.constructor != null) {
        ...
        if (enc != null) {
            ...
            if (isNode(obj)) {
                node = (mxClient.IS_IE || mxClient.IS_IE6) ? obj.value.cloneNode(true) : this.document.importNode(obj.value, true);
            } else {
...
mxCodecRegistry.register(function() {
    ...
    codec.afterEncode = function(enc, obj, node) {
        if (obj.value != null && obj.value.nodeType == mxConstants.NODETYPE_ELEMENT) {
            var tmp = node;
            node = (mxClient.IS_IE || mxClient.IS_IE6) ? obj.value.cloneNode(true) : enc.document.importNode(obj.value, true);
...
if (!(mxClient.IS_IE || mxClient.IS_IE6) && !false && !false) {
