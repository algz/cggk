...
if(Ext.grid.Grid){
   Ext.grid.Grid.prototype.ddText = "{0} oznaèen?ch riadkov";
}
...
if(Ext.DatePicker){
   Ext.apply(Ext.DatePicker.prototype, {
      todayText         : "Dnes",
      minText           : "Tento dátum je men?í ako minimálny mo?n? dátum",
      maxText           : "Tento dátum je v?è?í ako maximálny mo?n? dátum",
      disabledDaysText  : "",
      disabledDatesText : "",
      monthNames        : Date.monthNames,
      dayNames          : Date.dayNames,
      nextText          : '?al?í Mesiac (Control+Doprava)',
...
if(Ext.form.TextField){
   Ext.apply(Ext.form.TextField.prototype, {
      minLengthText : "Minimálna d??ka pre toto pole je {0}",
      maxLengthText : "Maximálna d??ka pre toto pole je {0}",
...
if(Ext.form.VTypes){
   Ext.apply(Ext.form.VTypes, {
      ...
      alphaText    : 'Toto po?e mo?e obsahova? iba písmená a znak _',
      alphanumText : 'Toto po?e mo?e obsahova? iba písmená,èísla a znak _'
   });
}
