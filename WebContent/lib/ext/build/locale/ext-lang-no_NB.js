/**
 *
 * Norwegian translation (Bokm?l: no-NB)
...
if(Ext.DatePicker){
  Ext.apply(Ext.DatePicker.prototype, {
    todayText         : "I dag",
    minText           : "Denne datoen er f?r tidligste tillatte dato",
    maxText           : "Denne datoen er etter seneste tillatte dato",
    disabledDaysText  : "",
    disabledDatesText : "",
    monthNames	      : Date.monthNames,
    dayNames		      : Date.dayNames,
    nextText          : 'Neste m?ned (Control+Pil H?yre)',
    prevText          : 'Forrige m?ned (Control+Pil Venstre)',
    monthYearText     : 'Velg en m?ned (Control+Pil Opp/Ned for ? skifte ?r)',
...
if(Ext.form.TextField){
  Ext.apply(Ext.form.TextField.prototype, {
    ...
    maxLengthText : "Den st?rste lengden for dette feltet er {0}",
    blankText     : "Dette feltet er p?krevd",
    regexText     : "",
    emptyText     : null
  });
}
...
if(Ext.form.DateField){
  Ext.apply(Ext.form.DateField.prototype, {
    ...
    minText           : "Datoen i dette feltet m? v?re etter {0}",
    maxText           : "Datoen i dette feltet m? v?re f?r {0}",
    invalidText       : "{0} er ikke en gyldig dato - den m? v?re p? formatet {1}",
    format            : "d.m.y",
...
if(Ext.form.VTypes){
   Ext.apply(Ext.form.VTypes, {
      emailText    : 'Dette feltet skal v?re en epost adresse p? formatet "bruker@domene.no"',
      urlText      : 'Dette feltet skal v?re en link (URL) p? formatet "http:/'+'/www.domene.no"',
...
if(Ext.form.HtmlEditor){
  Ext.apply(Ext.form.HtmlEditor.prototype, {
    ...
    buttonTips : {
      bold : {
        title: 'Fet (Ctrl+B)',
        text: 'Gj?r den valgte teksten fet.',
        cls: 'x-html-editor-tip'
      },
      italic : {
        title: 'Kursiv (Ctrl+I)',
        text: 'Gj?r den valgte teksten kursiv.',
        cls: 'x-html-editor-tip'
      },
      underline : {
      ...
      increasefontsize : {
        ...
        text: 'Gj?r fontst?rrelse st?rre.',
        cls: 'x-html-editor-tip'
      },
      decreasefontsize : {
        title: 'Forminsk tekst',
        text: 'Gj?r fontst?rrelse mindre.',
        cls: 'x-html-editor-tip'
      },
      backcolor : {
      ...
      forecolor : {
        title: 'Font farge',
        text: 'Endre farge p? den valgte teksten.',
        cls: 'x-html-editor-tip'
      },
      justifyleft : {
      ...
      justifyright : {
        title: 'H?yrejuster tekst',
        text: 'H?yrejuster teksten.',
        cls: 'x-html-editor-tip'
      },
      insertunorderedlist : {
        title: 'Punktliste',
      ...
      createlink : {
        title: 'Lenke',
        text: 'Gj?r den valgte teksten til en lenke.',
        cls: 'x-html-editor-tip'
      },
      sourceedit : {
        title: 'Rediger kilde',
...
if(Ext.layout.BorderLayout.SplitRegion){
  Ext.apply(Ext.layout.BorderLayout.SplitRegion.prototype, {
    splitTip            : "Dra for ? endre st?rrelse.",
    collapsibleSplitTip : "Dra for ? endre st?rrelse. Dobbelklikk for ? skjule."
  });
}
