...
if(Ext.DatePicker){
   Ext.apply(Ext.DatePicker.prototype, {
      ...
      maxText           : "Taj datum je poslije najve?eg datuma",
      disabledDaysText  : "",
      disabledDatesText : "",
      monthNames	: Date.monthNames,
      dayNames		: Date.dayNames,
      nextText          : 'Slijede?i mjesec (Control+Desno)',
...
if(Ext.grid.GridView){
   Ext.apply(Ext.grid.GridView.prototype, {
      sortAscText  : "Sortiraj rastu?im redoslijedom",
      sortDescText : "Sortiraj padaju?im redoslijedom",
