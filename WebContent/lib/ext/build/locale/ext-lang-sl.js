/**
 * Slovenian translation by Matja? (UTF-8 encoding)
 * 25 April 2007
 */
...
if(Ext.DatePicker){
   Ext.apply(Ext.DatePicker.prototype, {
      ...
      prevText          : 'Prej?nji mesec (Control+Levo)',
...
if(Ext.form.TextField){
   Ext.apply(Ext.form.TextField.prototype, {
      minLengthText : "Minimalna dol?ina tega polja je {0}",
      maxLengthText : "Maksimalna dol?ina tega polja je {0}",
...
if(Ext.form.VTypes){
   Ext.apply(Ext.form.VTypes, {
      ...
      alphanumText : 'To polje lahko vsebuje samo ?rke, ?tevilke in _'
   });
}

if(Ext.grid.GridView){
   Ext.apply(Ext.grid.GridView.prototype, {
      sortAscText  : "Sortiraj nara??ajo?e",
...
if(Ext.layout.BorderLayout.SplitRegion){
   Ext.apply(Ext.layout.BorderLayout.SplitRegion.prototype, {
      splitTip            : "Potegni za raz?iritev.",
      collapsibleSplitTip : "Potegni za raz?iritev. Dvojni klik, ?e ?elite skriti."
   });
}
