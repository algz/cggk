...
if(Ext.form.NumberField){
   Ext.apply(Ext.form.NumberField.prototype, {
      ...
      nanText : "{0} n?o é um número válido"
   });
}
...
if(Ext.form.DateField){
   Ext.apply(Ext.form.DateField.prototype, {
      ...
      invalidText       : "{0} n?o é uma data válida - deve ser informado no formato {1}",
      format            : "d/m/Y"
   });
}
...
if(Ext.form.VTypes){
   Ext.apply(Ext.form.VTypes, {
      emailText    : 'Este campo deve ser um endere?o de e-mail válido, no formado "usuario@dominio.com.br"',
...
if(Ext.form.HtmlEditor){
   Ext.apply(Ext.form.HtmlEditor.prototype, {
	 ...
	 buttonTips : {
           ...
           sourceedit : {
               title: 'Editar Fonte',
               text: 'Troca para o modo de edi??o de código fonte.',
               cls: 'x-html-editor-tip'
           }
        }
   });
