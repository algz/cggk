...
/*
 * Note that this control should still be treated as an example and that the API
 * will most likely change once it is ported into the Ext core as a standard
 * form control. This is still planned for a future release, so this should not
 * yet be treated as a final, stable API at this time.
 */
 ...
 *          Ext.ux.DDView class to provide drag/drop capability both within the
 *          list and also between multiple MultiSelect controls (see the
 *          Ext.ux.ItemSelector).
 * 
...
Ext.ux.Multiselect = Ext.extend(Ext.form.Field, {
	 ...
	 */
	/**
	 * @cfg {Ext.ux.DDView} view The Ext.ux.DDView used to render the
	 *      multiselect list.
	 */
	/**
