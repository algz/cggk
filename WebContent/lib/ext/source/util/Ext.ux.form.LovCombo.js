	...
	initComponent : function() {
		...
		if (!this.tpl) {
			this.tpl = '<tpl for=".">' + '<div class="x-combo-list-item">'
					...
					+ '<div style="width:' + (this.listWidth-50) + 'px;'
					+ (Ext.isIE6 ? 'float:left;clear:right;' : '')
					+ 'overflow:hidden;text-overflow:ellipsis;word-break:break-all" title="{' + (this.displayField || 'text') + '}">{'
