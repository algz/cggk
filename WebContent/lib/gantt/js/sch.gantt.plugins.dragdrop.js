...
Ext.extend(Sch.gantt.plugins.DragDrop, Ext.util.Observable, {
    ...
    cleanUp : function() {
    	//edit by suny 2011-1-27,this.grid.dragZone可能为空
            ...
            onDragDrop: function(e, id){
                ...
                if (start) {
                    ...
                    if (start && me.validatorFn.call(me.validatorFnScope || me, data.record, start, data.duration) !== false) {
                        ...
                        data.record.endEdit();
                        valid = true;
                        Sch.ganttQuantityMain.updateTaskTimes(data.record.get("Id"),data.record.get("StartDate"),data.record.get("EndDate"));
