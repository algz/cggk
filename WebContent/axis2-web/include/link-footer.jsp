...
<table width="100%">
	<tr><td>
		<table width="950px">
			<tr>
				<td align="right"><a href="axis2-web/index.jsp">Back Home</a>&nbsp;&nbsp;|&nbsp;&nbsp; <a href="javascript:void(0);" onclick="javascript:window.location.reload(true);return false;">Refresh</a></td>
			</tr>
		</table>
	</td>
	<td>&nbsp;</td></tr>
