 ...
 * 可以增加清除trigger,目前该clear功能只调用了当前组件的reset(),
 * 可以通过监听clearvalue来增加额外的处理
 */
Ext.form.DateField = Ext.extend(Ext.form.TwinTriggerField,  {
    /**
     * @cfg {String} format
...
disabledDates: ["^03"]
    ...
    initComponent : function(){
        ...
        this.addEvents(
            ...
            'select',
            /**
             * fires when the clear trigger is clicked
             */
            'clearvalue'
        );
...
dateField.setValue('2006-05-04');
    ...
    setValue : function(date){
    	if(this.enableClearValue==true&&this.disabled !== true&&this.readOnly !== true){
    ...
    onKeyUp : function(e){
    	if(this.enableClearValue==true&&this.disabled !== true && this.editable !== false && this.readOnly !== true && !e.isSpecialKey()){
        	/*
        	 * down press up时，up以后获取的才是其输入的值
        	 */
