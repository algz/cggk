 ...
 * 可以增加combobox的清除trigger,目前该clear功能只调用了当前组件的reset(),
 * 可以通过监听clearvalue来增加额外的处理
 */
Ext.form.ComboBox = Ext.extend(Ext.form.TwinTriggerField, {
    /**
...
var menu = new Ext.menu.Menu({
    ...
    onKeyUp : function(e){
        var k = e.getKey();
        if(this.disabled !== true && this.editable !== false && this.readOnly !== true && (k == e.BACKSPACE || !e.isSpecialKey())){
        	if(this.enableClearValue==true){
            	/*
