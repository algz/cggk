package com.sysware.customize.hd.investment.equipreService.service;
...
public interface EquipServiceManageService {
	 ...
	 * @return
	 */
	List<EquipServiceManageVo> getGridData(EquipServiceManageVo vo);
	/**
	 * 修改设备大修执行计划审批状态
	 * @param id
	 * @param flag
