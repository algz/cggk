...
import com.sysware.customize.hd.investment.equipreService.EquipreServiceRemote;
...
public class JsonServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Lifecycle.beginCall();
			...
			EquipreServiceRemote remote = (EquipreServiceRemote)Component.getInstance("wlzl_WlzlRemote",true);
