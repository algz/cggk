package com.sysware.customize.hd.investment.civilService.servlet;
...
public class EquipreServiceUtil {
	 ...
	 * @param datalist
	 */
	public void createExcelStream(HttpServletResponse response, String filename, String[] heads, List<EquipreServiceVo> datalist) {
		...
		try {
			...
			for (int i = 0; i < datalist.size(); i++) {
				...
				EquipreServiceVo vo = datalist.get(i);
