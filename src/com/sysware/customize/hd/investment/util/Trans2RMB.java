...
//        System.out.println("\n--------将数字转换成中文金额的大写形式------------\n");   
        ...
        String s = t2r.cleanZero(t2r.splitNum(t2r.roundString("12311111.12")));   
        // 如果转换过后是一个空串，则不输出屏幕   
        if(!"".equals(s)) {   
...
//        System.out.println("\n---------------------------------------------");   
    ...
    public  static String getAmout(String amout){
    	  Trans2RMB t2r = new Trans2RMB();   
          String s = t2r.cleanZero(t2r.splitNum(t2r.roundString(amout)));   
          // 如果转换过后是一个空串，则不输出屏幕   
//          if(!"".equals(s)) {   
//              System.out.println("转换成中文后为：" + s);;   
//          }   
