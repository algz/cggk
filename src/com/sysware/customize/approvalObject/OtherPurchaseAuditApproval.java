...
@Name("approval_OtherPurchaseAudit_Handler")
public class OtherPurchaseAuditApproval implements IApprovalHandler {
	...
	public boolean onFlowBegin(ApprovalObject arg0) {
		index=1;
		ParityService parityService = (ParityService) Component.getInstance("parityServiceImpl",true);
		parityService.updateProperties(StringUtil.split(arg0.getObjectID(), ','),"3");
		return false;
	}
