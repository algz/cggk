...
@Name("approval_CivilDetails_Handler")
public class CivilDetailsApproval implements IApprovalHandler{
	...
	public boolean onFlowBegin(ApprovalObject approvalObject) {
		...
		for(String id : objIds){
//			更新审批状态
			peSummaryServiceImpl.updateApprovalState(id,"4","CivilDetails");
		}
		return false;
	}
	...
	public boolean onFlowEnd(ApprovalObject approvalObject)
		...
		for(String id : objIds){
			peSummaryServiceImpl.updateApprovalState(id,type,"CivilDetails");
