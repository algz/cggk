...
@Name("approval_EquipPlan_Handler")
public class EquipPlanApproval implements IApprovalHandler{
	...
	public boolean onFlowBegin(ApprovalObject approvalObject) {
		...
		for(String id : objIds){
//			更新审批状态
			peSummaryServiceImpl.updateApprovalState(id,"4","EquipPlan");
		}
		return false;
	}
	...
	public boolean onFlowEnd(ApprovalObject approvalObject)
		...
		for(String id : objIds){
			peSummaryServiceImpl.updateApprovalState(id,type,"EquipPlan");
