...
@Name("approval_EquipPurchasePlan_Handler")
public class EquipPurchasePlanApproval implements IApprovalHandler{
	...
	public boolean onFlowBegin(ApprovalObject approvalObject) {
		...
		for(String id : objIds){
//			更新审批状态
			pePlanServiceImpl.updateApprovalState(id,"6","EquipPurchasePlan");
		}
		return false;
	}
	...
	public boolean onFlowEnd(ApprovalObject approvalObject)
		...
		for(String id : objIds){
			pePlanServiceImpl.updateApprovalState(id,type,"EquipPurchasePlan");
