...
@Name("approval_EquipRepair_Handler")
public class EquipRepairApproval implements IApprovalHandler{
	...
	public boolean onFlowBegin(ApprovalObject approvalObject) {
		...
		for(String id : objIds){
//			更新审批状态
			peDeclareServiceImpl.updateApprovalState(id,"2","EquipRepair");
		}
		return false;
	}
	...
	public boolean onFlowEnd(ApprovalObject approvalObject)
		...
		for(String id : objIds){
			peDeclareServiceImpl.updateApprovalState(id,type,"EquipRepair");
