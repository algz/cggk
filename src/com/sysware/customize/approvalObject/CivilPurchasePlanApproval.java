...
@Name("approval_CivilPurchasePlan_Handler")
public class CivilPurchasePlanApproval implements IApprovalHandler{
	...
	public boolean onFlowBegin(ApprovalObject approvalObject) {
		...
		for(String id : objIds){
//			更新审批状态
			pePlanServiceImpl.updateApprovalState(id,"6","CivilPurchasePlan");
		}
		return false;
	}
	...
	public boolean onFlowEnd(ApprovalObject approvalObject)
		...
		for(String id : objIds){
			pePlanServiceImpl.updateApprovalState(id,type,"CivilPurchasePlan");
