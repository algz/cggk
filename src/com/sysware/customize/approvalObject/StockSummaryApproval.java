...
@Name("approval_StockSummary_Handler")
public class StockSummaryApproval implements IApprovalHandler{
	...
	public boolean onFlowBegin(ApprovalObject approvalObject) {
		...
		for(String id : objIds){
//			更新审批状态
			peSummaryServiceImpl.updateApprovalState(id,"2","StockSummary");
		}
		return false;
	}
	...
	public boolean onFlowEnd(ApprovalObject approvalObject)
		...
		for(String id : objIds){
			peSummaryServiceImpl.updateApprovalState(id,type,"StockSummary");
