...
@Name("approval_EquipRepairPlan_Handler")
public class EquipRepairPlanApproval implements IApprovalHandler{
	...
	public boolean onFlowBegin(ApprovalObject approvalObject) {
		...
		for(String id : objIds){
//			更新审批状态
			pePlanServiceImpl.updateApprovalState(id,"6","EquipRepairPlan");
		}
		return false;
	}
	...
	public boolean onFlowEnd(ApprovalObject approvalObject)
		...
		for(String id : objIds){
			pePlanServiceImpl.updateApprovalState(id,type,"EquipRepairPlan");
