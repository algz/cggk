...
@Name("approval_CivilRepairSummary_Handler")
public class CivilRepairSummayApproval implements IApprovalHandler{
	...
	public boolean onFlowBegin(ApprovalObject approvalObject) {
		...
		for(String id : objIds){
//			更新审批状态
			peSummaryServiceImpl.updateApprovalState(id,"4","CivilRepairSummary");
		}
		return false;
	}
	...
	public boolean onFlowEnd(ApprovalObject approvalObject)
		...
		for(String id : objIds){
			peSummaryServiceImpl.updateApprovalState(id,type,"CivilRepairSummary");
