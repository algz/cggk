...
@Name("approval_EquipRegist_Handler")
public class EquipRegistApproval implements IApprovalHandler{
	...
	public boolean onFlowBegin(ApprovalObject approvalObject) {
		...
		for(String id : objIds){
//			更新审批状态
			peDeclareServiceImpl.updateApprovalState(id,"2","EquipRegist");
		}
		return false;
	}
	...
	public boolean onFlowEnd(ApprovalObject approvalObject)
		...
		for(String id : objIds){
			peDeclareServiceImpl.updateApprovalState(id,type,"EquipRegist");
