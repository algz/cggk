...
@Name("approval_SpecialProject_Handler")
public class SpecialProjectApproval implements IApprovalHandler{
	...
	public boolean onFlowBegin(ApprovalObject approvalObject) {
		...
		for(String id : objIds){
//			更新审批状态
			peSummaryServiceImpl.updateApprovalState(id,"2","SpecialProject");
		}
		return false;
	}
	...
	public boolean onFlowEnd(ApprovalObject approvalObject)
		...
		for(String id : objIds){
			peSummaryServiceImpl.updateApprovalState(id,type,"SpecialProject");
