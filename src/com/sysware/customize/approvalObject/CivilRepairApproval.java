...
@Name("approval_CivilRepair_Handler")
public class CivilRepairApproval implements IApprovalHandler{
	...
	public boolean onFlowBegin(ApprovalObject approvalObject) {
		...
		for(String id : objIds){
//			更新审批状态为审批中
			peDeclareServiceImpl.updateApprovalState(id,"2","CivilRepair");
		}
		return false;
	}
	...
	public boolean onFlowEnd(ApprovalObject approvalObject)
		...
		for(String id : objIds){
			peDeclareServiceImpl.updateApprovalState(id,type,"CivilRepair");
